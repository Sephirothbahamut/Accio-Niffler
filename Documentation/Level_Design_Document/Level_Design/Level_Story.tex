...
After bringing Delphini to Slytherin's dormitory, Minerva has to go back to Gryffindor's. 
...
\textbf{Cerberus Battle}

\paragraph{After first turn} Triggers after the first turn passed for both the player and the opponent:

\begin{dialogue}{} 
	\speak{Delphini}{Oh, right! Remember that lesson about magical creatures?}
	\speak{Minerva}{Since when you care about studying, and why are you bringing that up NOW?}
	\speak{Delphini}{The Somnus music Minerva, and he'll sleep like an harmless puppy!}
	\speak{Cerberus}{\*barks angrily.\*}
\end{dialogue} 

\textbf{Puzzle}

\paragraph{Delphini helped} Triggers when Delphini reaches Slytherin's Dormitory:
