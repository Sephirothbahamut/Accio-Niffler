...
\fullwidthgraphicscaption{../Pictures/Characters/Circumplexes/Minerva_circumplex.png} {Minerva's circumplex}
\pagebreak 
\fullwidthgraphicscaption{../Pictures/Characters/Relationship_maps/Minerva_relmap.png} {Minerva's relationship map}
\fullwidthgraphicscaption{../Pictures/Characters/Relationship_maps/Minerva_after_event_relmap.png}{Minerva's relationship map after Myrtle's death}

\pagebreak


\fullwidthgraphicscaption{../Pictures/Characters/Stat_sheets/Minerva_lv0_sheet.png}{Minerva's sheet}

\clearpage
\fullwidthgraphicscaption{../Pictures/Gameplay/Spells/Minerva_spell_tree.png}{Minerva's spell tree}
