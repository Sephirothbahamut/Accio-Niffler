...
\fullwidthgraphicscaption{../Pictures/Characters/Circumplexes/Delphini_circumplex.png}{Delphini's circumplex}
\pagebreak

\fullwidthgraphicscaption{../Pictures/Characters/Relationship_maps/Delphini_relmap.png} {Delphini's relationship map}
\fullwidthgraphicscaption{../Pictures/Characters/Relationship_maps/Delphini_after_event_relmap.png}{Delphini's relationship map after changing her mind thanks to Minerva}
\pagebreak

\fullwidthgraphicscaption{../Pictures/Characters/Stat_sheets/Delphini_lv0_sheet.png}{Delphini's sheet}


\pagebreak
\fullwidthgraphicscaption{../Pictures/Gameplay/Spells/Delphini_spell_tree.png}{Delphini's spell tree}
\clearpage
