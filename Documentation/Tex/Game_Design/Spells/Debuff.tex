...
Medium  spells\\
\begin{tabular}{ m{2cm}m{3cm}m{4cm}m{6cm} } 
	\includegraphics[width=2cm]{../Pictures/Gameplay/Spells/Icon/Impedimenta_spell_icon.png} & \textbf{Impedimenta} & Slows down or stops the target. & Change the time of up to 6 creatures on the field. Each target must succeed on a Wisdom saving throw or be affected by this spell for the duration. \\ 
